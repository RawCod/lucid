...
5.times do
  ...
  second_event = Event.new(user_id: user.id, name: "BOPAP", location: "Tate Modern, London, SE1 9TG", description: boris_description, category: "Nightmare", capacity: "133")
  ...
  third_event = Event.new(user_id: user.id, name: "MADONNA", location: "Sky Tower, 9 Hamilton Ave, Surfers Paradise QLD 4217, Australia", description: madonna_description, category: "Dream", capacity: "23")
  ...
  fourth_event = Event.new(user_id: user.id, name: "ZORRO", location: "Los Angeles, CA 90068, United States", description: zorro_description, category: "Nightmare", capacity: "666")
