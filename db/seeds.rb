...
5.times do
  ...
  event = Event.new(user_id: User.first.id, name: "SSAUNIER", location: "138 Kingsland Road, London, E2 8DY", description: seb_description, category: "Surprise", capacity: "84")
  ...
  second_event = Event.new(user_id: User.first.id, name: "BPAILLARD", location: "Tate Modern, London, SE1 9TG", description: boris_description, category: "Nightmare", capacity: "133")
  ...
  third_event = Event.new(user_id: User.first.id, name: "BPAILLARD", location: "Tate Modern, London, SE1 9TG", description: madonna_description, category: "Nightmare", capacity: "133")
  ...
  fourth_event = Event.new(user_id: User.first.id, name: "BPAILLARD", location: "Tate Modern, London, SE1 9TG", description: zorro_description, category: "Nightmare", capacity: "133")
