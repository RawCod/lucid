...
user = User.create(email: "hubabuba.pop@gmail.com", password: "Hello", first_name: "Holly", last_name: "Wrench")
5.times do
  ...
  event = Event.new(user_id: User.first.id, name: "SEBSAN", location: "138 Kingsland Road, London, E2 8DY", description: seb_description, category: "Surprise", capacity: "84")
  ...
  second_event = Event.new(user_id: User.first.id, name: "BOPAP", location: "Tate Modern, London, SE1 9TG", description: boris_description, category: "Nightmare", capacity: "133")
  ...
  third_event = Event.new(user_id: User.first.id, name: "MADONNA", location: "Sky Tower, 9 Hamilton Ave, Surfers Paradise QLD 4217, Australia", description: madonna_description, category: "Dream", capacity: "23")
  ...
  fourth_event = Event.new(user_id: User.first.id, name: "ZORRO", location: "Los Angeles, CA 90068, United States", description: zorro_description, category: "Nightmare", capacity: "666")
