...
5.times do
  ...
  event = Event.new(user_id: User.first.id, name: "SEBSAN", location: "138 Kingsland Road, London, E2 8DY", description: seb_description, category: "Surprise", capacity: 84, price: 25.00, date: "23rd Jan")
